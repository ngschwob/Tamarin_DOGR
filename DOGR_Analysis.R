...
# Two Proportion Z test (two sided)
  ...
  res
    # Proportion Radial: 0.9449541
    # X-squared = 51.619
    # p-value = 6.739e-13
    # 95% CI: [0.3326107, 0.5572976]
  sqrt(res$statistic)
...
# ~~ Seeing when Ulnar Grasps happened ------------------------------------

table(df$Grip_Type)
# There were 6 ulnar grasps included in the study


# Getting ulnar grasps to see who and when
  Ulnar_df <- df[df$Grip_Type == "-1",]
Ulnar_df
  #   Monkey    SesN    TrialN    Side    Hand    Grip    Grand Trial N
  #   Elaine    10         4      R       R       Ulnar   43
  #   Homer      1         4      R       R       Ulnar    2
  #   Lisa       4         6      R       R       Ulnar   12
  #   Lisa       5         3      R       R       Ulnar   15
  #   Lisa       5         4      R       R       Ulnar   16
  #   Mulva      3         3      R       R       Ulnar    4


# --- ---
# Elaine Session 10
# --- ---
  El10_df <- df[(df$Monkey == "Elaine" & df$Session_Num == 10),]
  El10_df
  
  # Ulnar trial was Right Baited Right Hand (should've been Left hand for radial)
  # Ulnar trial occurred after a LEFT baited trial where she used her right hand for radial
  # Possible she reused the previous RIGHT HAND plan, leading to an ulnar trial
  
  
# ---
# Homer Session 1
# ---
  Hm1_df <- df[(df$Monkey == "Homer" & df$Session_Num == 1),]
  Hm1_df
     
  # Ulnar trial was Right side baited Right hand (should've been left for radial)
  # Ulnar trial occurred after a BOTH baited trial where he used his right hand
  # Possible he reused his right hand plan leading to an ulnar trial
  
# ---
# Lisa Session 4
# ---
  Ls4_df <- df[(df$Monkey == "Lisa" & df$Session_Num == 4),]
  Ls4_df
  
  # Ulnar trial was Right baited Right hand (should've been left for radial)
  # Ulnar trial occurred after a LEFT baited trial where she used her right hand for radial
  # Possible she reused the previous RIGHT HAND plan, leading to an ulnar trial
...
# Lisa Session 5
# ---
  Ls5_df <- df[(df$Monkey == "Lisa" & df$Session_Num == 5),]
  Ls5_df

# Trial 3
  # Ulnar trial occurred Right side baited Right hand (should've been left for radial)
  # Ulnar trial #3 occurred right after BOTH side baited right hand
  # Possible she resued her RIGHT HAND plan, leading to an ulnar trial
# Trial 4
  # Ulnar trial occurred Right side baited Right hand (should;ve been left for radial)
  # Ulnar trial #4 occurred after a previous ulnar trial. Same sides baited, same outcomes
  # Could've been perserverating on the RIGHT HAND plan
  
# ---
# Mulva Session 3
# ---
  Mv5_df <- df[(df$Monkey == "Mulva" & df$Session_Num == 3),]
  Mv5_df
...
# Overall
# ---
  # Six of six reused hand of last trial (right)
  # Three of six occurred after a LEFT baited trial
  # Two of six occurred after a BOTH baited trial 
  # One of six occurred after another ulnar trial
